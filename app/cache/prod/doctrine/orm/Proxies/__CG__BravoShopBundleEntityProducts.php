...
namespace Proxies\__CG__\Bravo\ShopBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Products extends \Bravo\ShopBundle\Entity\Products implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bravo\\ShopBundle\\Entity\\Products' . "\0" . 'id', '' . "\0" . 'Bravo\\ShopBundle\\Entity\\Products' . "\0" . 'idCategory', '' . "\0" . 'Bravo\\ShopBundle\\Entity\\Products' . "\0" . 'title', '' . "\0" . 'Bravo\\ShopBundle\\Entity\\Products' . "\0" . 'price', '' . "\0" . 'Bravo\\ShopBundle\\Entity\\Products' . "\0" . 'description', '' . "\0" . 'Bravo\\ShopBundle\\Entity\\Products' . "\0" . 'img'];
        }
